...
function initFormHandler() {
  ...
  form.addEventListener("submit", (evt) => {
    evt.preventDefault(); // keep the page from refreshing

    const fd = new FormData(form);
    const recipeObject = {};
    fd.forEach((value, key) => {
      // turn the string values into numbers where appropriate
      recipeObject[key] = ["rating", "numRatings"].includes(key)
        ? Number(value)
        : value;
    });
    ...
    form.reset(); // UX nicety—clears the form
  });
